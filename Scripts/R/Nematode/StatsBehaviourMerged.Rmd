...
glmerOutNestTreatmentInfectionStatusSub1 <- spaMM::fitme(cbind(OutNestFrame, InNestFrame) ~ TreatmentInfectionStatus + (1|ColonyID), data = subset(AntTableFull, TreatmentInfectionStatus == "X_uninfected" | TreatmentInfectionStatus == "X_infected"), family = binomial(), method = "PQL")
